...
# Page Configuration
st.set_page_config(
    page_title="Ivermectin Stereochemistry Analysis",
    page_icon="🧪",
    layout="wide",
...
<div class="top-right-info">
    <p>Name: <b>yaseen kasnoor</b></p>
    <p>Class/Section: <b>AIML - A</b></p>
    <p>Roll No: <b>RA2511026050051</b></p>
</div>
""", unsafe_allow_html=True)

# Middle Top Header
st.markdown("<div class='center-title'><h1>Ivermectin Analysis</h1><p>Molecular Stereochemistry and Chiral Center Mapping</p></div>", unsafe_allow_html=True)

# Fixed Molecule: Ivermectin B1a
ivermectin_smiles = "CC[C@H](C)[C@@H]1[C@H](CC[C@@]2(O1)C[C@@H]3C[C@H](O2)C/C=C(/[C@H]([C@H](/C=C/C=C/4\\CO[C@H]5[C@@]4([C@@H](C=C(C5O)C)C(=O)O3)O)C)O[C@H]6C[C@H](OC)[C@@H](O[C@H]7C[C@H](OC)[C@@H](O)[C@H](C)O7)[C@H](C)O6)C)\\C"

try:
    mol = Chem.MolFromSmiles(ivermectin_smiles)
    ...
    if mol:
        ...
        with col1:
            ...
            st.image(img, use_container_width=True, caption="Structural representation of Ivermectin")
