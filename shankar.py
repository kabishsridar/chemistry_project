...
# Page Configuration
st.set_page_config(
    page_title="Eribulin Stereochemistry Analysis",
    page_icon="🧪",
    layout="wide",
...
<div class="top-right-info">
    <p>Name: <b>Shanala shankar</b></p>
    <p>Class/Section: <b>AIML - A</b></p>
    <p>Roll No: <b>RA2511026050037</b></p>
</div>
""", unsafe_allow_html=True)
...
try:
    ...
    if mol:
        ...
        with col1:
            ...
            st.image(img, use_container_width=True, caption="Structural representation of Eribulin")
