...
# Page Configuration
st.set_page_config(
    page_title="Artemether Stereochemistry Analysis",
    page_icon="🧪",
    layout="wide",
...
<div class="top-right-info">
    <p>Name: <b>Ummarvali muzakir</b></p>
    <p>Class/Section: <b>AIML - A</b></p>
    <p>Roll No: <b>RA2511026050021</b></p>
</div>
""", unsafe_allow_html=True)

# Middle Top Header
st.markdown("<div class='center-title'><h1>Artemether Analysis</h1><p>Molecular Stereochemistry and Chiral Center Mapping</p></div>", unsafe_allow_html=True)

# Fixed Molecule: Artemether
artemether_smiles = "CO[C@H]1OC2O[C@@]3(C)CCC4[C@H](C)CCC([C@H]1C)[C@@]24OO3"
...
try:
    ...
    if mol:
        ...
        with col1:
            ...
            st.image(img, use_container_width=True, caption="Structural representation of Artemether")
