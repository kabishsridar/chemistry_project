...
# Page Configuration
st.set_page_config(
    page_title="Yohimbine Stereochemistry Analysis",
    page_icon="🧪",
    layout="wide",
...
<div class="top-right-info">
    <p>Name: <b>Meka Yaswanth sai</b></p>
    <p>Class/Section: <b>AIML - A</b></p>
    <p>Roll No: <b>RA2511026050022</b></p>
</div>
""", unsafe_allow_html=True)

# Middle Top Header
st.markdown("<div class='center-title'><h1>Yohimbine Analysis</h1><p>Molecular Stereochemistry and Chiral Center Mapping</p></div>", unsafe_allow_html=True)

# Fixed Molecule: Yohimbine
yohimbine_smiles = "COC(=O)[C@H]1[C@H](CC[C@@H]2[C@@H]1C[C@H]3C4=C(CCN3C2)C5=CC=CC=C5N4)O"

try:
    mol = Chem.MolFromSmiles(yohimbine_smiles)
    ...
    if mol:
        ...
        with col1:
            ...
            st.image(img, use_container_width=True, caption="Structural representation of Yohimbine")
